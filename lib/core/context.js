 ...
 * @returns {Object} Defaults object with factory functions
 */
function createDefaults(config, campaignData) {
    ...
    return {
        ...
        iOSDevices: () => u.weighArray(devices.iOS),
        androidDevices: () => u.weighArray(devices.android),
        desktopDevices: () => u.weighArray(devices.desktop),
 ...
 * @returns {Object} Runtime state with counters and flags
 */
 ...
 * @param {Object} storage - Storage containers (optional, can be set later)
 * @returns {Object} Context object containing all state and dependencies
 */
 ...
 * @param {Object} storage - New storage containers
